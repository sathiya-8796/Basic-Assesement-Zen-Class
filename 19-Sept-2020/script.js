...
avObject.insert({ type: "Dog", name: "Tiny", age: 3, gender: "Male", color: "red" });
avObject.insert({ type: "Dog", name: "Caeser", age: 8, gender: "Male", color: "brown" });
avObject.insert({ type: "Turtle", name: "Rio", age: 11, gender: "Female", color: "dark green", owners: 2 });
avObject.insert({ type: "Dog", name: "browny", age: 7, gender: "Male", color: "black" });
avObject.insert({ type: "Cat", name: "meow", age: 9, gender: "Female", color: "white", owners: 1 });
avObject.insert({ type: "Cat", name: "blacky", age: 5, gender: "Female", color: "brown", owners: 3 });
avObject.insert({ type: "Parrot", name: "meow", age: 3, gender: "Female", color: "green" });
